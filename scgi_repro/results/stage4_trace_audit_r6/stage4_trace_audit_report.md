...
| stage4_ured_otsu_soft_pilot_stripe       | stripe_target | 64          | 3.828          | cfg0045           | 12.35          | cfg0061           | 15              | True               |
| stage4_ured_otsu_soft_fixedstep_stripe   | stripe_target | 78          | 12.35          | cfg0022           | 12.35          | cfg0040           | 15              | True               |
| stage4_ured_binary_prior_pilot_stripe    | stripe_target | 8           | 9.711          | cfg0002           | 9.711          | cfg0002           | 32              | False              |
| stage4_ured_prompt_capacity_micro_stripe | stripe_target | 160         | 9.67           | cfg0048           | 9.67           | cfg0080           | 32              | False              |
...
| stripe_target | stage4_ured_otsu_soft_fixedstep_stripe | 12.35          | cfg0022           | True               | 15          | 0.062       |
...
| stripe_target | stage4_ured_otsu_soft_pilot_stripe | 12.35          | cfg0061           | 15              | True               |

## Interpretation

All objects have a target-aware trace point above the APL URED minimum.
