...
| stripe_target | nlm_earlystop_stripe | 8.932          | cfg0006           | False              | 40          | 0.06        |
...
| stripe_target | nlm_allobjects | 8.932          | cfg0000           | 40              | False              |

## Interpretation

At least one object remains below the APL URED minimum even with target-aware trace selection: stripe_target (8.93).
