...
| stripe_target | stage4_ured_prompt_capacity_micro_stripe | 9.67           | cfg0048           | False              | 32          | 0.062       |
...
| stripe_target | stage4_ured_prompt_capacity_micro_stripe | 9.67           | cfg0080           | 32              | False              |

## Interpretation

At least one object remains below the APL URED minimum even with target-aware trace selection: stripe_target (9.67).
