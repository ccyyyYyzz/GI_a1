...
| Stage 4 SCGI-UNN and SCGI-URED | Partial | Full 500-step matrix now includes SCGI-UNN and SCGI-URED for four held-out targets; URED is above UNN on all four, but mean/min CNRs are only 5.084/2.270 vs APL URED minimum 10.43. Follow-up stripe screens show avg-pool RED final/trace CNR 2.916/3.831 and NLM RED final/trace CNR 5.131/8.913. The repaired all-object NLM audit reaches final CNRs 8.453/6.033/10.270/7.842 for A/stripe/L/ring, still below the all-target APL URED gate |
